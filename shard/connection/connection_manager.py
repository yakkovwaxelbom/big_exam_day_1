...
from connection.mysql import MySqlConnection
...
class ConnectionsManager:
    ...
    _registry = {
        'mysql': (MySqlConnection, MySqlConfig),
    ...
    def _load_connection(cls, name: str):
        ...
        log_event(f'Success to connect to {name}')
    ...
    def get_connection(cls, name: str):
        ...
        if conn is None:
            coon = cls._connections[name] = cls._load_connection(name)
